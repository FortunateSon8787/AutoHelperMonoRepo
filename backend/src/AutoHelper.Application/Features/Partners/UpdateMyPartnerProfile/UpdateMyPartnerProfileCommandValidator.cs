...
public sealed class UpdateMyPartnerProfileCommandValidator : AbstractValidator<UpdateMyPartnerProfileCommand>
{
    public UpdateMyPartnerProfileCommandValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
            .MaximumLength(256);
