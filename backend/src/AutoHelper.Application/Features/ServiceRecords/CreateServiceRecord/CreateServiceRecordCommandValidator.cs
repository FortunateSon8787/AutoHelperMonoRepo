...
public sealed class CreateServiceRecordCommandValidator : AbstractValidator<CreateServiceRecordCommand>
{
    public CreateServiceRecordCommandValidator()
    {
        ...
        RuleFor(x => x.DocumentUrl)
            .NotEmpty()
            .WithMessage("DocumentUrl is required. Upload the PDF first.");
    }
}
