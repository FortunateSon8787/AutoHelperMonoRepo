...
public static class ChatsEndpoints
{
        ...
        CancellationToken ct)
    {
        ...
        return Results.Created(
            ...
            new CreateChatApiResponse(
                result.Value.ChatId,
                result.Value.InitialAssistantReply,
                result.Value.DiagnosticResultJson,
                result.Value.WorkClarificationResultJson,
                result.Value.PartnerAdviceResultJson,
    ...
    private sealed record CreateChatApiResponse(
        Guid ChatId,
        string? InitialAssistantReply,
        string? DiagnosticResultJson,
        string? WorkClarificationResultJson,
        string? PartnerAdviceResultJson,
        string ChatStatus,
        bool WasValid);
