...
✅ Частично реализован Epic AUT-7 (Админ): AUT-28 (управление клиентами: список/поиск/блокировка + отображение невалидных запросов к чатботу), AUT-29 (управление автомобилями: список/поиск по VIN/марке/модели)
