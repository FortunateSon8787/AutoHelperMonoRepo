...
SaaS-платформа для учёта автомобилей, истории их обслуживания, AI-диагностики и подбора партнёров (автосервисы, эвакуаторы, автомойки и др.). Подробные бизнес-требования: `.claude/AutoHelper_Requirements_v1.6.md`.
...
✅ Частично реализован Epic AUT-4 (AI-чат): AUT-17 (чат-инфраструктура), AUT-19 (Режим 1: FaultHelp — многошаговая диагностика + DiagnosticResultCard на фронтенде), AUT-20 (Режим 2: WorkClarification — одношаговый анализ работ + рыночные бенчмарки)
✅ Частично реализован Epic AUT-7 (Админ): AUT-28 (управление клиентами: список/поиск/блокировка + отображение невалидных запросов к чатботу), AUT-29 (управление автомобилями: список/поиск по VIN/марке/модели), AUT-30 (управление партнёрами: список/поиск/верификация/деактивация/удаление + раздел профнепригодных + удаление отзывов), AUT-31 (управление рекламными кампаниями: список/поиск по partnerId/активация/деактивация + дашборд статистики), AUT-32 (аутентификация и роли администраторов: AdminUser агрегат, AdminRole enum, /api/admin/auth/login + /logout, seeding SuperAdmin, страница /admin/login, admin middleware), AUT-162 (конфигурация АвтоПомощника: вкл/выкл чатбот, max символов, дневные лимиты по планам, цены разового пополнения, отключение предложений партнёров в Режиме 1, страница /admin/chatbot-config)
🔲 В планах: AUT-5 (Биллинг), AUT-8 (Фронтенд), AUT-9 (DevOps), AUT-150 (Soft-delete + Аудит)
